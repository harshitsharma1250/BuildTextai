  ...
  export const contentTemplates = [
    {
      ...
      desc: "An AI tool that generate instagram captions from your information",
      category: "Instagram",
      icon: FaInstagramSquare,
      aiPrompt:
        "Give me some good examples of instagram captions on given niche give me result in Rich Text Editor format. The captions should be good and unique.",
